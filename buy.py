...
def load_data():
    ...
    st.session_state.min_shop_price = int(
        settings.get(
            "min_shop_price",
            1000
        )
    ...
    st.session_state.bonus_cap = int(
        settings.get(
            "bonus_cap",
            7000
        )
    ...
    st.session_state.spu_multiplier = int(
        settings.get(
            "spu_multiplier",
            0
        )
...
save_col, load_col, file_col = st.columns(
    [2, 2, 4]
)
